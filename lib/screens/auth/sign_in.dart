...
class SignIn extends StatefulWidget {
  ...
  const SignIn({Key? key, this.toggleRegister}) : super(key: key);
      ...
      appBar: AppBar(
        ...
        actions: [
          TextButton.icon(
            ...
            icon: Icon(Icons.person_add, color: Colors.green[300]),
            label: Text(
              'Register',
              ...
              TextButton(
                onPressed: () async {
                  if(formKey.currentState!.validate()){
                    dynamic result = await auth.emailSignIn(email, password);
                    if(result == null){
